            ...
            13: [
                function (e, r, t) {
                    ...
                    r.exports = function (e, r, t) {
                        ...
                        a = d
                            ? ((s += " var schema" + o + " = " + e.util.getData(n.$data, i, e.dataPathArr) + "; "),
                              "schema" + o)
                            : n;
                        var f = "maximum" == r,
                            ...
                            for (var p, m = -1, v = f.length - 1; m < v; )
                                (p = f[(m += 1)]),
                                    (e.opts.strictKeywords
                                        ...
                                        n && ((a += " if (" + u + ") { "), (c += "}")));
                        return (
                            n && (a += d ? " if (true) { " : " " + c.slice(0, -1) + " "), (a = e.util.cleanUpCode(a))
                        );
                    };
                },
                {},
            ...
            22: [
                function (e, r, t) {
                    ...
                    r.exports = function (e, r, t) {
                        ...
                        s = m
                            ? ((o += " var schema" + i + " = " + e.util.getData(l.$data, n, e.dataPathArr) + "; "),
                              "schema" + i)
                            : l;
                        var v,
                            y,
                            ...
                            if (ae)
                                for (var se, oe = -1, ie = ae.length - 1; oe < ie; ) {
                                    ...
                                    if (
                                        ...
                                        (d.schema = Y),
                                            (d.schemaPath =
                                                e.schemaPath + ".patternProperties" + e.util.getProperty(se)),
                                            (d.errSchemaPath =
                ...
                function (e, r, t) {
                    ...
                    r.exports = function (a, e, r) {
                        ...
                        if (
                            ...
                            !0 !== a.opts.extendRefs &&
                                ((o = !1),
                                a.logger.warn('$ref: keywords ignored in schema at path "' + a.errSchemaPath + '"'));
                        }
                        if (
                            (a.schema.$comment &&
                                a.opts.$comment &&
                            ...
                            if (_ || S || !0 === F || (F && !Y(F))) {
                                (d = a.schemaPath + ".type"),
                                    ...
                                    (f = a.errSchemaPath + "/type");
                                if (
                                    ((t += " if (" + a.util[S ? "checkDataTypes" : "checkDataType"](b, m, !0) + ") { "),
                                    _)
                                ) {
                                    var x = "dataType" + c,
                                        R = "coerced" + c;
                ...
                function (e, r, t) {
                    ...
                    (a = this),
                        (function (e) {
                                ...
                                return (
                                    ...
                                    void 0 !== e.path &&
                                        (e.path = String(e.path)
                                            .replace(t.PCT_ENCODED, r)
                                            .replace(e.scheme ? t.NOT_PATH : t.NOT_PATH_NOSCHEME, p)
                                            .replace(t.PCT_ENCODED, f)),
                                    void 0 !== e.query &&
                                ...
                                if (s) {
                                    ...
                                    if (r.unicodeSupport || (o && o.unicodeSupport)) y(t, a);
                                        ...
                                        if (t.host && (r.domainHost || (o && o.domainHost)))
                                            try {
                                                t.host = v.toASCII(t.host.replace(a.PCT_ENCODED, m).toLowerCase());
                                            } catch (e) {
                                                t.error =
                                                    t.error ||
                            ...
                            function j(r) {
                                ...
                                if ((s && s.serialize && s.serialize(r, t), r.host))
                                    if (e.IPV6ADDRESS.test(r.host));
                                        ...
                                        try {
                                            r.host = t.iri
                                                ? v.toUnicode(r.host)
                                                : v.toASCII(r.host.replace(e.PCT_ENCODED, m).toLowerCase());
                                        } catch (e) {
                                            r.error =
                                                r.error ||
                                ...
                                var o = (function (e, r) {
                                    ...
                                    return (
                                        ...
                                        void 0 !== e.host &&
                                            a.push(
                                                g(S(String(e.host), t), t).replace(t.IPV6ADDRESS, function (e, r, t) {
                                                    return "[" + r + (t ? "%25" + t : "") + "]";
                                                })
                                            ),
                                        "number" == typeof e.port && (a.push(":"), a.push(e.port.toString(10))),
                                ...
                                if (
                                    ...
                                    var i = r.path;
                                    t.absolutePath || (s && s.absolutePath) || (i = D(i)),
                            ...
                            function I(e, r) {
                                return e && e.toString().replace(r && r.iri ? l.PCT_ENCODED : n.PCT_ENCODED, m);
                            }
                            var U = {
                                    scheme: "http",
                                    domainHost: !0,
                                    ...
                                    serialize: function (e, r) {
                                        ...
                                        if (a) {
                                            for (var s = 0, o = a.length; s < o; ++s) {
                                                var i = String(a[s]),
                                                    n = i.lastIndexOf("@"),
                                                    l = i.slice(0, n).replace(G, ee).replace(G, f).replace(Y, p),
                                                    c = i.slice(n + 1);
                                                try {
                                        ...
                                        for (var d in u)
                                            u[d] !== H[d] &&
                                                h.push(
                                                    d.replace(G, ee).replace(G, f).replace(W, p) +
                                                        "=" +
                                                        u[d].replace(G, ee).replace(G, f).replace(X, p)
                                                );
                                        return h.length && (t.query = h.join("&")), t;
                                    },
                                },
                                te = /^([^\:]+)\:(.*)/,
                                ae = {
                            ...
                            (d[U.scheme] = U),
                                ...
                                (e.escapeComponent = function (e, r) {
                                    return e && e.toString().replace(r && r.iri ? l.ESCAPE : n.ESCAPE, p);
                                }),
                            ...
                            if (
                                !(t =
                                    ...
                                    (function (e) {
                                        ...
                                        return (
                                            (e._opts.defaultMeta =
                                                "object" == typeof r ? e._getId(r) || r : e.getSchema(p) ? p : void 0),
                                            e._opts.defaultMeta
                                        );
                                    })(this))
                            )
